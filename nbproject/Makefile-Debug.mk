...
${OBJECTDIR}/helperfuncs.o: helperfuncs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/helperfuncs.o helperfuncs.c

${OBJECTDIR}/timers.o: timers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/timers.o timers.c
...
${OBJECTDIR}/movementRightCheck.o: movementRightCheck.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/movementRightCheck.o movementRightCheck.c
...
${OBJECTDIR}/movementLeftCheck.o: movementLeftCheck.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/movementLeftCheck.o movementLeftCheck.c

${OBJECTDIR}/clocks.o: clocks.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/clocks.o clocks.c
...
${OBJECTDIR}/adc.o: adc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/adc.o adc.c

${OBJECTDIR}/IR.o: IR.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/IR.o IR.c

${OBJECTDIR}/shapes.o: shapes.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/shapes.o shapes.c

${OBJECTDIR}/Interrupts.o: Interrupts.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Interrupts.o Interrupts.c

${OBJECTDIR}/LCD.o: LCD.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/LCD.o LCD.c
